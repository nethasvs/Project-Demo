...
<h5> Localmachine --> Github --> Dockerhub --> Jenkins (Ansible playbook and Artifacts) --> ec2 machine --> Kubernetes --> Website <h5>
<h6> last Kubernetes CI/CD fully automatically <h6>
